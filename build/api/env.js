...
exports.default = (app) => {
    app.use('/', route);
    route.get('/envs', async (req, res, next) => {
    ...
    route.post('/envs', celebrate_1.celebrate({
        body: celebrate_1.Joi.object({
            value: celebrate_1.Joi.string().required(),
            name: celebrate_1.Joi.string().required(),
            remarks: celebrate_1.Joi.string().optional(),
        }),
    }), async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
    ...
    route.put('/envs', celebrate_1.celebrate({
        body: celebrate_1.Joi.object({
            value: celebrate_1.Joi.string().required(),
            name: celebrate_1.Joi.string().required(),
            remarks: celebrate_1.Joi.string().optional(),
    ...
    route.delete('/envs', celebrate_1.celebrate({
    ...
    route.put('/envs/:id/move', celebrate_1.celebrate({
    ...
    route.put('/envs/disable', celebrate_1.celebrate({
        body: celebrate_1.Joi.array().items(celebrate_1.Joi.string().required()),
    }), async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
    ...
    route.put('/envs/enable', celebrate_1.celebrate({
        body: celebrate_1.Joi.array().items(celebrate_1.Joi.string().required()),
    }), async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
    ...
    route.put('/envs/name', celebrate_1.celebrate({
        body: celebrate_1.Joi.object({
    ...
    route.get('/envs/:id', celebrate_1.celebrate({
        params: celebrate_1.Joi.object({
            id: celebrate_1.Joi.string().required(),
        }),
    }), async (req, res, next) => {
